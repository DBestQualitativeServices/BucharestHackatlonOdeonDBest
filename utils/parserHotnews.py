...
class HotNews:
    def __init__(self):
        self.url = "https://www.hotnews.ro/rss"
        # self.url = "https://www.hotnews.ro/rss/economie"
        # self.url = "http://www.hotnews.ro/rss/life"
        # self.url = "http://www.hotnews.ro/rss/sport"
        # self.url = "http://www.hotnews.ro/rss/revista"
        self.repository = ArticleRepository()

    def parse(self):
        print("Parsing HotNews")
        ...
        self.repository.add_articles(source_articles)
        print("Finished Parsing Jurnalul")
        # return result

jurnalul_parser = HotNews()
